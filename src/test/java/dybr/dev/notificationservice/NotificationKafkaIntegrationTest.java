...
import dybr.dev.notificationservice.model.UserOperation;
...
class NotificationKafkaIntegrationTest {
    ...
    @Autowired
    private KafkaTemplate<Long, UserNotification> kafkaTemplate;
